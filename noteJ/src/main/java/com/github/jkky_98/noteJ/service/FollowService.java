...
public class FollowService {
    ...
    @Transactional
    public void follow(String following, String getFollowing) {
        User userFollowing = userRepository.findByUsername(following).orElseThrow(() -> new EntityNotFoundException("follow를 신청한 User를 찾을 수 없습니다. 세션 로그인 유저와 일치할 것..."));
        User userGetFollowing = userRepository.findByUsername(getFollowing).orElseThrow(() -> new EntityNotFoundException("follow를 당한 User를 찾을 수 없습니다"));
        // 검증 및 Follow 엔티티 생성
